...
/*! Oo3d 0.0.22 //// MIT Licence //// http://oo3d.richplastow.com/ */

(function() {
  var Camera, Layer, Main, Program, Renderer, RendererWireframe, RendererXXOLD, Scene, Shader, Shape, getFragmentSource, getVertexSource, mat4, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªW, ªX, ªex, ªhas, ªisU, ªredefine, ªtype, ªuid,
  ...
  Layer = (function() {
    ...
    function Layer(main1, config) {
      ...
      if (ªN !== ªtype(config.rendererI)) {
        throw TypeError("config.rendererI must be number not " + (ªtype(config.rendererI)));
      }
      this.renderer = this.main.renderers[config.rendererI] || (function() {
        throw RangeError("No such index " + config.rendererI + " in main.renderers");
      })();
    }
  ...
  Renderer = (function() {
    ...
    Renderer.prototype.render = function() {
      ...
      if (this.scissor) {
        gl.scissor(this.scissor[0] * $main.width, this.scissor[1] * $main.height, this.scissor[2] * $main.width, this.scissor[3] * $main.height);
      }
      index = this.items.length;
      while (index--) {
