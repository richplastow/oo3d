...
/*! Oo3d 0.0.17 //// MIT Licence //// http://oo3d.richplastow.com/ */

(function() {
  var Camera, Main, Scene, Shape, Tudor, getFragmentSource, getVertexSource, mat4, tudor, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªW, ªX, ªex, ªhas, ªisU, ªredefine, ªtype, ªuid,
  ...
  Main = (function() {
    ...
    Main.prototype.addShape = function(config) {
      ...
      this.shapes[index] = new Shape(config, this.gl);
      return index;
    };
    ...
    Main.prototype.render = function() {
      ...
      while (index--) {
        ...
        this.gl.uniformMatrix4fv(this.uMatTransformLoc, false, new Float32Array(shape.matTransform));
        mode = this.gl[shape.renderMode];
        this.gl.drawArrays(mode, 0, shape.count);
