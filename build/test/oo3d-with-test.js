...
/*! Oo3d 0.0.11 //// MIT Licence //// http://oo3d.richplastow.com/ */

(function() {
  var Buffer, Camera, Main, Tudor, getFragmentSource, getVertexSource, mat4, tudor, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªW, ªX, ªex, ªhas, ªredefine, ªtype, ªuid,
  ...
  Camera = (function() {
    ...
    function Camera(scene, config) {
      ...
      this.matCameraProjection = mat4.perspective(this.fovy, this.aspect, 1, 100);
  ...
  Main = (function() {
    ...
    Main.prototype.transform = function(config) {
      ...
      if (ªU === typeof config.target) {
        matCurrent = this.camera.matCameraTransform;
      } else {
      ...
      if (ªU === typeof config.target) {
        this.camera.matCameraTransform = matNew;
