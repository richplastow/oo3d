...
/*! Oo3d 0.0.25 //// MIT Licence //// http://oo3d.richplastow.com/ */

(function() {
  var Camera, Item, Layer, Main, Program, Renderer, Tudor, mat4, tudor, ª, ªA, ªB, ªC, ªE, ªF, ªN, ªO, ªR, ªS, ªU, ªV, ªW, ªX, ªex, ªhas, ªisU, ªredefine, ªtype, ªuid,
  ...
  Main = (function() {
    ...
    Main.prototype.addItem = function(config) {
      ...
      this.items[index] = new Item(this, config);
      return index;
    };
